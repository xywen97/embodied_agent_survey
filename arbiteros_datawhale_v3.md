...
香港中文大学 CURELab 团队全面开源了 **ArbiterOS V1.0**，一个完全在本地运行的 AI Agent 治理内核**。它就像你电脑里的杀毒软件，只不过传统杀毒查"恶意文件"，**它专门查"恶意动作"**。
...
本项目由 **香港中文大学 CURELab 团队** 全面开源。香港中文大学 CURELab 实验室由徐强教授领导，专注于Agentic AI, Multi-modal Learning, Time Series, 以及 AI Security/Debug等方向，具有深厚的关于AI和安全相关的科研和技术储备。

![团队合影/实验室 logo]

**XXX 教授** 毕业于 [学校]，获博士学位，现任 XX大学 [学院] [职位]，曾担任 [顶会] 程序委员会 [角色] 等。
